<template>
    <div id="profile" class="page">
        <div id="profile-updated-successfully" class="notification success" v-show="false">
            个人信息更新成功!
        </div>
        ...
        <div class="grid-container" v-show="userLoadStatus === 2">
            ...
            <div class="grid-x grid-padding-x">
                <div class="large-8 medium-10 small-12 cell center">
                    <label>是否公开个人信息
                        <select id="public_visibility" v-model="profile_visibility" >
        ...
        watch:{
            ...
            'userUpdateStatus':function () {
                if(this.userUpdateStatus===2){
                    $('#profile-updated-successfully').show(true).delay(5000).fadeOut();
                }
        ...
        methods:{
            ...
            updateProfile(){
                if(this.validateProfile()){
                    // console.log(this.public_visibility);
                    this.$store.dispatch('editUser',{

                        public_visibility: this.profile_visibility,
