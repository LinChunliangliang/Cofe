...
class AlterUsersAddProfileFields extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->text('favorite_coffee')->after('avatar')->comment('喜欢的咖啡');
            $table->text('flavor_notes')->after('favorite_coffee')->comment('口味');
            $table->boolean('profile_visibility')->default('1')->after('flavor_notes')->comment('是否显示个人信息');
